...
//	<!-- ============================================================== -->
	...
	public function getAllUsers($role = '')
	{
		switch ($role) { //status: 1:new, 2: register, 3: activated, 4: suspended, 5: deactivated, 6: deleted, 7: full
			case '1' : //superadmin
				$sql = "SELECT * FROM users WHERE (id_user_status = '1' OR id_user_status = '2' OR id_user_status = '3' OR id_user_status = '4' OR id_user_status = '5' OR id_user_status = '6') AND (id_user_roles = '1' OR id_user_roles = '2' OR id_user_roles = '3' OR id_user_roles = '4' OR id_user_roles = '5' OR id_user_roles = '6' OR id_user_roles = '7' OR id_user_roles = '8')";
				break;
			case '2' : //admin
				$sql = "SELECT * FROM users WHERE ( id_user_status = '2' OR id_user_status = '3' OR id_user_status = '4')
AND(id_user_roles = '2' OR id_user_roles = '3' OR id_user_roles = '4' OR id_user_roles = '5' OR id_user_roles = '6' OR id_user_roles = '8')";
				break;
			case '3' : //supervisor
				$sql = "SELECT * FROM users WHERE ( id_user_status = '3')
AND(id_user_roles = '3' OR id_user_roles = '4' OR id_user_roles = '5' OR id_user_roles = '6' OR id_user_roles = '8')";
				break;
			case '4' : //tecnitian
				$sql = "SELECT * FROM users WHERE ( id_user_status = '3')
AND(id_user_roles = '4' OR id_user_roles = '5' OR id_user_roles = '6' OR id_user_roles = '8')";
				break;
			case '5' : //client // user role 8 is an employee of a client
				$sql = "SELECT * FROM users WHERE ( id_user_status = '3' OR id_user_status = '2')AND(id_user_roles = '5' OR id_user_roles = '8')";
	...
	public function getAllUsersListExec()
	{

		$sql = "SELECT * FROM users WHERE (id_user_status = '1' OR id_user_status = '2' OR id_user_status = '3' OR id_user_status = '4' OR id_user_status = '5' OR id_user_status = '6') AND (id_user_roles = '1' OR id_user_roles = '2' OR id_user_roles = '3' )";
		$this->db->order_by("id", "desc");
		$data = $this->db->query($sql)->result();
		return $data;
	}
	...
	public function getAllUsersFilter($role = '', $id = '')
	{
		switch ($role) { //status: 1:new, 2: register, 3: activated, 4: suspended, 5: deactivated, 6: deleted, 7: full
			case '1' : //superadmin
				$sql = "SELECT * FROM users WHERE (id_user_status = '1' OR id_user_status = '2' OR id_user_status = '3' OR id_user_status = '4' OR id_user_status = '5' OR id_user_status = '6') AND (id_user_roles = '1' OR id_user_roles = '2' OR id_user_roles = '3' OR id_user_roles = '4' OR id_user_roles = '5' OR id_user_roles = '6' OR id_user_roles = '7' OR id_user_roles = '8')";
...
AND(id_user_roles = '4' OR id_user_roles = '5' OR id_user_roles = '6' OR id_user_roles = '8')";
			...
			case '5' : //client // user role 8 is an employee of a client
				...
				$sql = "SELECT * FROM users WHERE ( id_user_status = '3' OR id_user_status = '2')AND(id_user_creator = '" . $id . "')AND(id_user_roles = '5' OR id_user_roles = '8')";
				if(($user->id_user_roles == '1')or($user->id_user_roles == '2')){
					$sql = "SELECT * FROM users WHERE ( id_user_status = '3' OR id_user_status = '2')AND(id_user_roles = '5' OR id_user_roles = '8')";
				}
				break;
			case '6' : //full user
	...
	public function cistu($idUser = '', $idUser2='')
	{
		...
		if ($idUser == $idUser2){
			...
			$this->db->where('id_referral', $idUser);
			$this->db->where('attendant_id', $idUser2);
			$query = $this->db->get();
			$data = $query->result();
			if ($data) {
				return true;
	...
	public function countAllUsers($role = '')
	{
		switch ($role) { //status: 1:new, 2: register, 3: activated, 4: suspended, 5: deactivated, 6: deleted, 7: full
			case '1' : //superadmin
				$sql = "SELECT COUNT(*) AS `count`  FROM users WHERE (id_user_status = '1' OR id_user_status = '2' OR id_user_status = '3' OR id_user_status = '4' OR id_user_status = '5' OR id_user_status = '6') AND (id_user_roles = '1' OR id_user_roles = '2' OR id_user_roles = '3' OR id_user_roles = '4' OR id_user_roles = '5' OR id_user_roles = '6' OR id_user_roles = '7' OR id_user_roles = '8')";
				break;
			case '2' : //admin
				$sql = "SELECT COUNT(*) AS `count`  FROM users WHERE ( id_user_status = '2' OR id_user_status = '3' OR id_user_status = '4')
AND(id_user_roles = '2' OR id_user_roles = '3' OR id_user_roles = '4' OR id_user_roles = '5' OR id_user_roles = '6' OR id_user_roles = '8')";
				break;
			case '3' : //supervisor
				$sql = "SELECT COUNT(*) AS `count`  FROM users WHERE ( id_user_status = '3')
AND(id_user_roles = '3' OR id_user_roles = '4' OR id_user_roles = '5' OR id_user_roles = '6' OR id_user_roles = '8')";
				break;
			case '4' : //tecnitian
				$sql = "SELECT COUNT(*) AS `count`  FROM users WHERE ( id_user_status = '3')
AND(id_user_roles = '4' OR id_user_roles = '5' OR id_user_roles = '6' OR id_user_roles = '8')";
				break;
			case '5' : //client // user role 8 is an employee of a client
				$sql = "SELECT COUNT(*) AS `count`  FROM users WHERE ( id_user_status = '3' OR id_user_status = '2')AND(id_user_roles = '5' OR id_user_roles = '8')";

				break;
			case '6' : //full user
				$sql = "SELECT COUNT(*) AS `count`  FROM users WHERE ( id_user_status = '-1')";
				break;
			default:
				$sql = "SELECT COUNT(*) AS `count`  FROM users WHERE ( id_user_status = '-1')";
				break;
