		...
		<div class="row">
			...
			<div class="col-lg-6">
				...
				<div class="col-lg-12">
					...
					<div class="card">
						<div class="card-body">
							<span class="font-18"> <strong>Datos de la Compañía:</strong></span>
						...
						<div class="comment-widgets scrollable">
							...
							<div class="d-flex flex-row m-t-0 border-top">
								<div class="comment-text w-100">
									<h6 class="font-medium"><strong>Nombre de la Compañía:</strong></h6>
									<span class="m-b-15 d-block "><?php echo $company->name ?></span>
								</div>
							</div>
							<!-- Comment Row -->
							<div class="d-flex flex-row  m-t-0 border-top">
								<div class="comment-text w-100">
									<h6 class="font-medium "><strong>Tipo:</strong></h6>
									<span
											class="m-b-15 d-block"><?php echo $company->type ?> </span>
								</div>
							</div>
							<!-- Comment Row -->
							<div class="d-flex flex-row  m-t-0 border-top">
								<div class="comment-text w-100">
									<h6 class="font-medium"><strong>Industria:</strong></h6>
									<span class="m-b-15 d-block"><?php echo $company->industry ?></span>
								</div>
							</div>
							<!-- Comment Row -->
							<div class="d-flex flex-row  m-t-0 border-top">
								<div class="comment-text w-100">
									<h6 class="font-medium"><strong>Dirección Legal:</strong></h6>
									<span class="m-b-15 d-block"><?php echo $company->legal_address ?></span>
								</div>
							</div>
							<!-- Comment Row -->
							<div class="d-flex flex-row  m-t-0 border-top">
								<div class="comment-text w-100">
									...
									<span class="m-b-15 d-block"><?php echo $company->phone ?></span>
								</div>
							</div>
							<!-- Comment Row -->
							<div class="d-flex flex-row  m-t-0 border-top">
								<div class="comment-text w-100">
									...
									<span class="m-b-15 d-block"><?php echo $company->email ?></span>
								</div>
							</div>
							<!-- Comment Row -->
							<div class="d-flex flex-row  m-t-0 border-top">
								<div class="comment-text w-100">
									<h6 class="font-medium"><strong>Website:</strong></h6>
									<span class="m-b-15 d-block"><?php echo $company->website ?></span>
								</div>
							</div><!-- Comment Row -->
							<div class="d-flex flex-row  m-t-0 border-top">
								<div class="comment-text w-100">
									<h6 class="font-medium"><strong>Referido:</strong></h6>
									<a href="<?php echo base_url() ?>/usersABM/user/<?php echo($referral->id) ?>">
										<span class="m-b-15 d-block"><b><?php echo($referral->username) ?>: </b><?php echo($referral->name_first . ' ' . $referral->name_last) ?></span>
									</a>
								</div>
							</div>
						...
						<?php if ($this->session->userdata('role') < 4) {
							...
							<div class="card" style="margin-bottom: -20px">
								<a href="<?php echo base_url() . 'companiesABM/companyMod/' . $company->id ?>"
				...
				<?php if ($this->session->role < 4) {
					...
					<div class="col-lg-6">
						...
						<div class="card">
							...
							<a href="<?php echo base_url() . 'companiesABM/companyHistory/' . $company->id ?>"
							<button type="button" class="btn btn-success">
								Ver Histórico
							</button>
							</a>
			...
			<div class="row" style="margin-top: 10px">
				<div class="col-lg-12">
					...
					<div class="card">
						<div class="card-body">
							<h4 class="card-title m-b-0">Tiendas</h4>
						</div>
						<ul class="list-style-none">
							<?php if (empty($stores)) { ?>
								<li class="d-flex no-block card-body border-top">
							...
							<?php foreach ($stores as $store): ?>
								...
								<li class="d-flex no-block card-body border-top">
									<i class="fm-r-10 mdi mdi-store"></i>
									<div style="margin-left: 10px;">
										Tienda: <b><?php echo $store->name ?></b>, Dirección:
										<b><?php echo $store->address ?></b>, Teléfono:
										<b><?php echo $store->phone ?></b>, Email:
										<b><?php echo $store->email ?></b>, Responsable:
										<b><?php echo $store->attendant_id ?></b>
									</div>
									<div class="ml-auto">
										<a href="<?php echo base_url() . 'storesABM/store/' . $store->id; ?>">
											<button type="button" class="btn btn-cyan btn-sm">Ver</button>
										</a>
