			...
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						...
						?>
						<a href="<?php base_url()?>companiesAdd/">
							...
							<table id="zero_config" class="table table-striped table-bordered">
								...
								<?php foreach ($companies as $company):?>
									<tr>
										...
										<td>
											<a href="<?php echo base_url().'companiesABM/company/'.$company->id;?>"><button type="button" class="btn btn-cyan btn-sm">Ver</button>
											</a>
											<?php if ($this->session->role < 4) {
											?>
											<a href="<?php echo base_url().'companiesABM/companyMod/'.$company->id;?>"><button type="button" class="btn btn-success btn-sm">Modificar</button></a>
											<?php }?>
