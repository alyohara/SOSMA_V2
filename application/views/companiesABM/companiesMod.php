			...
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						...
						<!-- New Company Form -->
						<!-- ============================================================== -->
						<h5 class="title" id="exampleModalLabel">Editar Compañía <b><?php echo($company->name) ?> </b></h5>
						<div class="">

							<!-- Form -->
							<?php
							$attributes = array('class' => 'form-horizontal m-t-20', 'id' => 'newUserForm');
							echo form_open(base_url() . 'companiesABM/companyMod/' . $company->id, $attributes);
							...
							<div class="row p-b-30">
								...
								<span class="input-group-text bg-success text-white" id="basic-addon1"><i
										...
										<?php echo form_dropdown($company_type['name'], $company_type['options'], $company_type['selected'], $company_type['extra']); ?>
									</div>
								</div>
								...
								<span class="input-group-text bg-success text-white" id="basic-addon1"><i
										...
										<?php echo form_dropdown($industry['name'], $industry['options'], $industry['selected'], $industry['extra']); ?>
									</div>
								...
								<span class="input-group-text bg-success text-white" id="basic-addon1"><i
										...
										<?php echo form_textarea($legal_address); ?>
									</div>
								</div>
								<div class="col-md-12">
									<div class="input-group mb-3">
