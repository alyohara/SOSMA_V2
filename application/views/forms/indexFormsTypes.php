...
<div class="container-fluid">
	...
	<div class="row">
					...
					<div class="card">
						<div class="card-body">
								...
								<div class="box bg-danger text-center">
									<h1 class="font-light text-white">Esta tienda no tiene formularios asociados</h1>
								</div>
					...
					<div class="col-md-6 col-lg-2 col-xlg-3">
						<div class="card card-hover">
							<div class="box bg-white text-center">
								...
								<a href="<?php base_url() ?>/forms/forms/<?php echo $type['id'] ?>/<?php echo $indexStore ?>/<?php echo $company_id?>">
									<img src="../../../assets/icons/folderIconType.png" width="120px">
									<h1 class="font-light text-white"><i></i></h1>
									<h6 class="text-black-50"><?php echo $type['form_name'] ?></h6>
								</a>
							</div>
						</div>
					</div>
		...
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					<a href="<?php base_url() ?>../../company/<?php echo $company_id ?>">
