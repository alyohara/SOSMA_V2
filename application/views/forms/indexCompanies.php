						...
						<div class="card">
							<div class="card-body">
									...
									<div class="box bg-danger text-center">
										<h1 class="font-light text-white">No tiene compañías asociadas</h1>
									</div>
						...
						<div class="col-md-6 col-lg-2 col-xlg-3">
							<div class="card card-hover">
								<div class="box bg-white text-center">
									<a href="<?php base_url() ?>company/<?php echo $company->id ?>">
										<img src="../assets/icons/folderIcon.png" width="120px">
										<h1 class="font-light text-white"><i></i></h1>
										<h6 class="text-black-50"><?php echo $company->name ?></h6>
									</a>
								</div>
							</div>
						</div>
