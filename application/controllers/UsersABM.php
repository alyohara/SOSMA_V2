...
class UsersABM extends CI_Controller
{
	...
	function check_role($id1, $id2)
	{
		$user1 = $this->users->getUserById($id1);
		$user2 = $this->users->getUserById($id2);
		$check = false;
		if ($user1->id_user_roles <= $user2->id_user_roles) {
			if ($user1->id_user_creator == $user2->id) {
				$check = true;
			}
		}
		if ($user2->id_user_roles == 1) {
			$check = true;
		}
		return $check;
	}
	...
	public function index()
	{
		if (isset($_SESSION['user_id'])) {
			...
			// get all users
			// ==============================================================
			$users = $this->users->getAllUsers($this->session->role, $_SESSION['user_id']);
			// ==============================================================
			// end get all users
			// ==============================================================
	...
	public function usersAdd()
	{
		if (isset($_SESSION['user_id'])) {
			...
			// get all roles
			// ==============================================================
			$userAux = $this->users->getUserById($_SESSION['user_id']);
			$roles = $this->roles->getRolesSelectByMineRole($userAux->id_user_roles);
			// ==============================================================
			// end get all roles
			// ==============================================================
			...
			$this->form_validation->set_rules('username', 'username', 'required|min_length[5]|max_length[500]|is_unique[users.username]',
				array(
...
//			);
	...
	public function user($id = '')
	{
		...
		if (isset($_SESSION['user_id'])) {
			if ($this->users->cistu($_SESSION['user_id'], $id)) {

				$user1 = $this->users->getUserById($id);
				$user2 = $this->users->getUserById($_SESSION['user_id']);
				$check = true;
				if ($user1->id_user_roles <= $user2->id_user_roles) {
					if ($user1->id_user_creator == $user2->id) {
						$check = true;
				...
				if ($check) {
					...
					// get my companies
					// ==============================================================
					$companies = $this->companies->getAllCompaniesByIdReferral($id);
					// ==============================================================
					// end get  my companies
					// ==============================================================
					// ==============================================================
					// get my stores
					// ==============================================================
					$stores = $this->stores->getAllStoresByUserId($id);
					// ==============================================================
					// end get  my stores
					// ==============================================================
					// ==============================================================
					// get my visits
					// ==============================================================
					$visitas = $this->visitasAux->getAllVisitasById($id);
					// ==============================================================
					// end get  my visits
					// ==============================================================
